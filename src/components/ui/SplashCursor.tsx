  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      if (gl2 instanceof WebGL2RenderingContext) {
          ...
          if (gl1 instanceof WebGLRenderingContext) {
              gl = gl1;
          }
      }

      if (!gl) {
        // Can't get any WebGL context.
    ...
    function getSupportedFormat(gl: WebGL2RenderingContext | WebGLRenderingContext, internalFormat: any, format: any, type: any) {
    ...
    function drawDisplay(target: any, width: number, height: number) {
    ...
    function getResolution(resolution: number) {
      ...
      if (aspectRatio < 1) return { width: Math.round(resolution), height: Math.round(resolution / aspectRatio) };
